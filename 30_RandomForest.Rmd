...
print(rf.heightAll)
save(rf.heightAll, file = 'C:/Users/gorge/Documents/GIS DataBase/amazon maximum height extras/objects/randomForest.Rdata')
...
importanceRF = varImp(rf.heightAll)
```
...
#heightRaster = predict(scaledLayers, rf.heightAll)
