...
**Rodar antes PreparingRasters.Rmd**
...
ggplot(temp, aes(lightning, altura_cop)) + 
  geom_point(colour = 'darkgray') +
  geom_point(data = efficientBorderFiltered, colour = "black") +
...
ggplot(temp, aes(fapar, altura_cop)) + 
  geom_point(colour = 'darkgray') +
  geom_point(data = efficientBorderFiltered, colour = "black") +
...
ggplot(temp, aes(pannual, altura_cop)) + 
  geom_point(colour = 'darkgray') +
  geom_point(data = efficientBorderFiltered, colour = "black") +
...
ggplot(temp, aes(pseason, altura_cop)) + 
  geom_point(colour = 'darkgray') +
  geom_point(data = efficientBorderFiltered, colour = "black") +
...
ggplot(temp, aes(clayContent, altura_cop)) + 
  geom_point(colour = 'darkgray') +
  geom_point(data = efficientBorderFiltered, colour = "black") +
