...
marginalUspeed = ggplot() + 
  ...
  xlab('u-Speed (m/s)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalVspeed = ggplot() + 
  ...
  xlab('v-Speed (m/s)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalClearDays = ggplot() + 
  ...
  xlab('Number of clear days (days/yr)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalDays20 = ggplot() + 
  ...
  xlab('Days with more then 20 mm (days/yr)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalLightning = ggplot() + 
  ...
  xlab('Lightning (rate of lights)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalMonth100 = ggplot() + 
  ...
  xlab('Month with precipitation greater than 100 mm (months/yr)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalPannual = ggplot() + 
  ...
  xlab('Annual precipitation (mm)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalPdriest = ggplot() + 
  ...
  xlab('Precipitation of the driest month (mm)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalPet = ggplot() + 
  ...
  xlab('Potential Evapotranspiration (mm)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalPseason = ggplot() + 
  ...
  xlab('Precipitation seasonality (mm)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalPwettest = ggplot() + 
  ...
  xlab('Precipitation of the wettest month (mm)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalTannual = ggplot() + 
  ...
  xlab('Annual temperature (°C)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalTseason = ggplot() + 
  ...
  xlab('Temperature seasonality (°C)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalTmax = ggplot() + 
  ...
  xlab('Maximum temperature (°C)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalClayContent = ggplot() + 
  ...
  xlab('Clay content (%)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
marginalWaterContent = ggplot() + 
  ...
  xlab('Water content (%)') + ylab('Height (m)') +
  theme_bw() + theme(panel.grid.major = element_blank(), 
                     panel.grid.minor = element_blank(),
                     panel.background = element_blank(), 
                     axis.line = element_line(colour = "black"))
...
png('./plot/marginalPlotsP1.png', units = 'cm', width = 20, height = 30, res = 300)
...
png('./plot/marginalPlotsP2.png', units = 'cm', width = 20, height = 30, res = 300)
grid.arrange(myplot1, myplot2, myplot3, myplot4, myplot5, myplot6, ncol=2)
dev.off()
...
png('./plot/marginalPlotsP3.png', units = 'cm', width = 20, height = 30, res = 300)
grid.arrange(myplot1, myplot2, myplot3, myplot4, myplot5, myplot6, ncol=2)
dev.off()
